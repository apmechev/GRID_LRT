...
function setup_DDF_env(){
source $1/init_killms.sh
export PYTHONPATH=$1/DDFacet:$PYTHONPATH
    

}

function setup_ddf-pipeline(){
export PYTHONPATH=${PWD}/ddf-pipeline/scripts:$PYTHONPATH
export PYTHONPATH=${PWD}/ddf-pipeline/utils:$PYTHONPATH
export PATH=${PWD}/ddf-pipeline/utils:$PATH
export PATH=${PWD}/ddf-pipeline/scripts:$PATH
