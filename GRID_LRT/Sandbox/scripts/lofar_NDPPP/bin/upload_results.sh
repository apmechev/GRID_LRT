...
function upload_results_cal(){
 ...
 globus-url-copy instruments_${OBSID}_${STARTSB}.tar gsiftp://gridftp.grid.sara.nl:2811/pnfs/grid.sara.nl/data/lofar/user/sksp/spectroscopy-migrated/ndppp/cal_tables/${OBSID}/cal_results_${OBSID}_${SSB}.tar
