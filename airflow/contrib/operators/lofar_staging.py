...
class LOFARStagingOperator(BaseOperator):
    ...
    def __init__(
        ...
        self.stager=stager_access
        self.state=State.QUEUED
        self.pass_threshold=0.96 #At least 98% need to be staged to continue.
...
#    SKIPPED = "skipped"
    ...
    def execute(self, context):
        ...
        logging.info("Successfully sent staging command for " + 
                     ...
                     + " files.")
        logging.debug("StageID= " + str(self.stage_Status))
        ...
        self.p_bar.start()
        self.started=False
        while self.still_running():  ##Include progressbar
    ...
    def not_yet_started(self):
        ...
        if self.progress['Status'] == 'scheduled':
